...
export class ProjectsComponent implements OnInit {
  users1: Array<IconUserModel> = [
    { name: 'Emma Smith', avatar: './assets/media/avatars/300-1.jpg' },
  ...
  users2 = [
    ...
    { name: 'Brian Cox', avatar: './assets/media/avatars/300-1.jpg' },
  ];

  users3 = [
    { name: 'Mad Masy', avatar: './assets/media/avatars/300-1.jpg' },
  ...
  users5 = [
    { name: 'Francis Mitcham', avatar: './assets/media/avatars/300-1.jpg' },
  ...
  users7 = [
    { name: 'Meloday Macy', avatar: './assets/media/avatars/300-1.jpg' },
